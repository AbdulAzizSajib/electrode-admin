...
export const queryKeys = {
  ...
  /*
   * Third-party connections — couriers, tracking pixels, whatever comes next.
   *
   * Separate from `courier` above, which answers "what can the selected courier
   * do and is it ready"; this answers "what is connected and what credentials
   * are stored". They overlap for couriers and diverge for everything else, and
   * a saved credential has to invalidate both.
   */
  integrations: {
